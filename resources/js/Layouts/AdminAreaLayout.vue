                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            >
                                <NavLink
                                    :href="route('admin.area.dashboard')"
                                    :active="route().current('admin.area.dashboard')"
                                >
                                    Dashboard
                                </NavLink>

                                <NavLink
                                    :href="route('admin.area.statistics.index')"
                                    :active="route().current('admin.area.statistics.index')"
                                >
                                    Estadisticas
                                </NavLink>
                            </div>
