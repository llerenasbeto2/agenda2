...
import EditReservationModal from '@/Components/Estatal/dashboard/EditReservationModal.vue';
import DeleteReservationModal from '@/Components/Estatal/dashboard/DeleteReservationModal.vue';
import Comentarios from '@/Components/Estatal/dashboard/Comentarios.vue';
import PaymentDetails from '@/Components/Estatal/dashboard/PaymentDetails.vue';
import StatusButtons from '@/Components/Estatal/dashboard/StatusButtons.vue';
...
const search = () => {
  router.get(route('admin.estatal.dashboard.index'), {
