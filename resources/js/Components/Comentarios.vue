...
const sendComment = async () => {
    if (comment.value.trim()) {
        ...
        console.log('Datos a enviar:', {
            reservation_id: typeof props.reservationId === 'object' ? props.reservationId.id : props.reservationId,
        ...
        try {
            const response = await axios.post(route('admin.general.events.send-comment'), {
                reservation_id: typeof props.reservationId === 'object' ? props.reservationId.id : props.reservationId,
                comment: comment.value.trim()
            });
